...
export function alpha2ToFlagEmoji(alpha2: string): string {
  ...
  const codePoints = Array.from(alpha2.toUpperCase()).map((char) => 127397 + char.charCodeAt(0));
...
export function alpha3ToFlagEmoji(alpha3: string | null | undefined): string | null {
